...
def main():
    ...
    cv2.namedWindow('train image', cv2.WINDOW_AUTOSIZE)
    ...
    cv2.namedWindow('query image transformed', cv2.WINDOW_AUTOSIZE)
    cv2.imshow('query image transformed', query_image_transformed_gray)

    cv2.namedWindow('mask_used_pixels', cv2.WINDOW_AUTOSIZE)
